...
import { 
  ...
  Bell, Database, Rocket, ChevronRight, Layers, Sparkles, Crown, Gem
} from 'lucide-react';
    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-black" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            Workflow <span className="text-gold">Plans</span>
          </h2>
          <p 
            className="text-white/60 text-base sm:text-lg max-w-2xl mx-auto"
            style={{
          ...
          >
            Choose the automation level that fits your business. One-time setup fee with lifetime workflow ownership.
          </p>
        </div>
        ...
        >
          All plans include free consultation. Workflows run forever - no monthly fees.
        </p>
      </div>
    </section>
  );
