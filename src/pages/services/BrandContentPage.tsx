              ...
              {[
                ...
                >
                  <div className="w-16 h-16 bg-gold/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    <span className="text-xl font-display text-gold"><AnimatedNumber value={item.metric} /></span>
                  </div>
    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-black" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            Choose the perfect plan for your content marketing needs. No hidden fees, just results.
          </p>
        </div>
